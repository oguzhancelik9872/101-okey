...
function getPlayerAvatarHTML(name, gender = null) {
  ...
  const avatarIndex = charCodeSum % 8;
  const list = isFemale ? femaleAvatars : maleAvatars;

  return list[avatarIndex] || list[0];
}

function getPlayerAvatarSVG(name, gender = null) {
  return getPlayerAvatarHTML(name, gender);
}
